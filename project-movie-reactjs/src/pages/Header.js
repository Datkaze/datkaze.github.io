            ...
            <div className="modal-content">
              <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li className="nav-item-login" role="presentation">
                  <button
                    className="nav-link-login top-set active"
                    id="pills-home-tab"
                    data-bs-toggle="pill"
                ...
                <li className="nav-item-login" role="presentation">
                  <button
                    className="nav-link-login left-set"
                  ...
                  >
                    <div className="modal-inner">
                      ...
                      <div className="oline d-flex justify-content-center">
                        <a href="#">
                          <img
                            src="https://firebasestorage.googleapis.com/v0/b/image-movie-app.appspot.com/o/banner-icon%2Ffacebook.png?alt=media&token=6ecdc874-4ab5-4da6-a3f6-dbcee72feda7"
                            alt=""
                          />
                        </a>
                        <a href="#">
                          <img
                            src="https://firebasestorage.googleapis.com/v0/b/image-movie-app.appspot.com/o/banner-icon%2Fgoogle.png?alt=media&token=3135bfb5-ad83-4700-bd3f-4541c6216a73"
                            alt=""
                          />
                        </a>
                      </div>
