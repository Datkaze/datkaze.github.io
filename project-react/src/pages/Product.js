        ...
        >
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval="2000">
              <img
                src="./picture-banner/banner1.png"
            ...
            <div className="carousel-item" data-bs-interval="2000">
              <img
                src="./picture-banner/banner2.png"
                className="d-block w-100"
                alt="banner"
              />
            </div>
            <div className="carousel-item" data-bs-interval="2000">
              <img
                src="./picture-banner/banner6.png"
                className="d-block w-100"
                alt="banner"
              />
            </div>
            <div className="carousel-item" data-bs-interval="2000">
              <img
                src="./picture-banner/banner8.png"
                className="d-block w-100"
                alt="banner"
              />
            </div>
      ...
      <section className="section-sp container">
        <div className="row">
          <div className="div d-flex" style="justify-content: space-between;">
            ...
            <a className="set-mg-sp1" href="Laptop.html">
              Xem tất cả
            </a>
          </div>
            ...
            <div className="card">
              <a href="chi-tiet-san-pham.html">
                <div className="card-img">
                  <img src="./picture-section-1/item1.png" alt="ảnh sản phẩm" />
                </div>
              </a>
              <div className="discount">-20%</div>
              <div className="card-body-set">
                <p className="card-text-set">Macbook Air 13-inch M1</p>
              ...
              <div className="d-flex text-center">
                ...
                <a className="btn2 col-6" href="chi-tiet-san-pham.html">
                  Mua Ngay
                </a>
              </div>
            </div>
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              <a href="chi-tiet-san-pham.html">
                <div className="card-img">
                  <img src="./picture-section-1/item2.png" alt="ảnh sản phẩm" />
                </div>
              </a>
              <div className="discount">-20%</div>
              <div className="card-body-set">
                <p className="card-text-set">Macbook Air 16-inch M1</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Laptop Asus Celeron N40</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-20%</div>
              <div className="card-body-set">
                <p className="card-text-set">Laptop Lenovo Ideapad 5</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Laptop Lenovo Ideapad 3</p>
                <div className="d-flex justify-content-center mb-2">
      ...
      <section className="section-sp container">
        <div className="row">
          <div className="div d-flex" style="justify-content: space-between;">
            ...
            <a className="set-mg-sp1" href="dien-thoai.html">
              Xem tất cả
            </a>
          </div>
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-20%</div>
              <div className="card-body-set">
                <p className="card-text-set">iphone 13 Pro Max</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-20%</div>
              <div className="card-body-set">
                <p className="card-text-set">iphone 12 128GB</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Xiaomi Mi 11</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Realme C3i 2GB/32GB</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Samsung Galaxy M12</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-18%</div>
              <div className="card-body-set">
                <p className="card-text-set">Oppo E9 Price</p>
                <div className="d-flex justify-content-center mb-2">
      ...
      <section className="section-sp container">
        <div className="row">
          <div className="div d-flex" style="justify-content: space-between;">
            ...
            <a className="set-mg-sp1" href="tivi.html">
              Xem tất cả
            </a>
          </div>
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              <a href="chi-tiet-san-pham.html">
                <div className="card-img">
                  <img src="./picture-section-1/item9.png" alt="ảnh sản phẩm" />
                </div>
              </a>
              <div className="discount">-20%</div>
              <div className="card-body-set">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              <a href="chi-tiet-san-pham.html">
                <div className="card-img">
                  <img src="./picture-section-1/item7.png" alt="ảnh sản phẩm" />
                </div>
              </a>
              <div className="discount">-18%</div>
              <div className="card-body-set">
                <p className="card-text-set">Tivi Samsung Smart 4K 50 inch</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Tivi Sony Smart 4K 49 inch</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              <a href="chi-tiet-san-pham.html">
                <div className="card-img">
                  <img src="./picture-section-1/item8.png" alt="ảnh sản phẩm" />
                </div>
              </a>
              <div className="discount">-16%</div>
              <div className="card-body-set">
                <p className="card-text-set">Android Tivi 4K Toshiba 55 inch</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Tivi LG Smart 4K 49 inch</p>
                <div className="d-flex justify-content-center mb-2">
                  <p className="para1">8.450.000 ₫</p>
                </div>
                <div className="d-flex justify-content-between">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-18%</div>
              <div className="card-body-set">
                <p className="card-text-set">Tivi Vsmart 4K 55 inch</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="discount">-22%</div>
              <div className="card-body-set">
                <p className="card-text-set">Tivi Vsmart 4K 50 inch</p>
                <div className="d-flex justify-content-center mb-2">
      ...
      <section className="section-sp container">
        <div className="row">
          <div className="div d-flex" style="justify-content: space-between;">
            ...
            <a className="set-mg-sp1" href="phu-kien.html">
              Xem tất cả
            </a>
          </div>
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Tai nghe bluetooth AirPods Pro</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Chuột máy tính OP20 Gaming</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Bàn phím cơ Dareu EK87 Switch</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Usp PEAK2-LK25GH36 128GB</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Tai nghe bluetooth Realme</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Tai nghe bluetooth AirPods 2</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Chuột máy tính DARE-U EM908</p>
                <div className="d-flex justify-content-center mb-2">
          ...
          <div className="col-lg-3 col-sm-6 my-2">
            <div className="card">
              ...
              <div className="card-body-set">
                <p className="card-text-set">Chuột máy tính Fuhlen G90</p>
                <div className="d-flex justify-content-center mb-2">
