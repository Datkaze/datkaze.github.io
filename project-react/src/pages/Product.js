...
<section className="banner-sp text-center">
    ...
    <section className="section-sp container">
      <div className="row">
        ...
        <Link className="set-mg-sp1" to="/laptop">Xem tất cả</Link>
        </div>
    ...
    <section className="section-sp container">
      <div className="row">
        ...
        <Link className="set-mg-sp1" to="/phone">Xem tất cả</Link>
        </div>
        <div className="col-lg-3 col-sm-6 my-2">
          <div className="card">
            <Link to="/productdetail">
    ...
    <section className="section-sp container">
      <div className="row">
        ...
        <Link className="set-mg-sp1" to="/tivii">Xem tất cả</Link>
        </div>
        <div className="col-lg-3 col-sm-6 my-2">
          <div className="card">
            <Link to="/productdetail">
    ...
    <section className="section-sp container">
      <div className="row">
        ...
        <Link className="set-mg-sp1" to="/phukien">Xem tất cả</Link>
        </div>
        <div className="col-lg-3 col-sm-6 my-2">
          <div className="card">
            <Link to="/productdetail">
