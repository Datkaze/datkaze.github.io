    ...
    <section className="section-tt-1">
            ...
            <a href="chi-tiet-tin-tuc.html">
                <div className="news1 row">
                    ...
                    <div className="col-lg-6">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem quae minima illo delectus eos consequatur nostrum eum asperiores dolorum soluta? Sequi aspernatur consectetur modi velit quae dignissimos repudiandae debitis voluptates!</p>
                            <div className="para-tt row">
                                <div className="col-lg-6 order-2 d-flex"><p>Tác giả:</p> <p style="font-weight: 500;">Đoàn Minh Đạt</p></div>
      ...
      <div className="news mt-2">
        <a href="chi-tiet-tin-tuc.html">
            <div className="news1 row">
                <div className="col-lg-6">
                    <img src="./picture-section-1/item20.png" alt="anh tin tuc"/>
                </div>
                <div className="col-lg-6">
